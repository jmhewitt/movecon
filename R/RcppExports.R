...
Test__AppliedLikelihoodFamily <- function(eastings, northings, semi_majors, semi_minors, orientations, t, states) {
    .Call(`_movecon_Test__AppliedLikelihoodFamily`, eastings, northings, semi_majors, semi_minors, orientations, t, states)
}
